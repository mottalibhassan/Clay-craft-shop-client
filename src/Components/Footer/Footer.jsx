    ...
    return (
        <div className="bg-slate-200">
            <footer className="footer p-10 container mx-auto text-base-content">
                ...
                <footer className="footer px-10 container mx-auto py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Clay Craft Shop <br/>Providing reliable tech since 1992</p>
                </aside> 
